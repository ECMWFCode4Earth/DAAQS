...
# create an ADS account at https://ads.atmosphere.copernicus.eu and load ADS credentials 
...
DATADIR = "./data"
variables = ['surface_pressure', 'temperature', 'carbon_monoxide', 'nitrogen_dioxide', 'ozone',
